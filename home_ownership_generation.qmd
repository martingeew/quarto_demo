...
Average home ownership has been dropping in each successive
generation at every given age group, see @fig-generation.
...
```
Average home ownership since 1986 has declined the most for those
aged 25-34, see @fig-age.
...
Baby boomers have been driving home ownership growth but their 
influence will begin to wane in the coming decade, see @fig-pop-distribution.
